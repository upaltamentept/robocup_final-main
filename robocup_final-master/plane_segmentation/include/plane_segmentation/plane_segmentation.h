...
private:
  ...
  void PlacedoneCallback(const std_msgs::Bool::ConstPtr& msg);
  void GraspdoneCallback(const std_msgs::Bool::ConstPtr& msg);
private:
  ...
  ros::Subscriber pick_or_place_sub_;
  ros::Subscriber grasp_done_sub_; 
